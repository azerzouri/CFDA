CREATE PROCEDURE [dm].[usp_DimReinsurance]
...
DECLARE @Ins_proc_id INT= 7

--- Insert the NA value SK
SET IDENTITY_INSERT [dm].[DimReinsurance] ON 

INSERT INTO [dm].[DimReinsurance]([reinsurane_SK],[reinsurerName],[sapiensReinsurerID],[brokerName],[sapiensBrokerID],[sapiensPoolID],
[sapiensBatchID],[audit_Insert_Dt],[audit_Update_Dt],[ins_Proc_ID],[upd_Proc_ID],[is_Deleted],[is_Active])

VALUES (0, 'NA',0,'NA',0,0,'NA',@InsertDate,NULL, @Ins_proc_id,NULL,0,1)

SET IDENTITY_INSERT [dm].[DimReinsurance] OFF 

-- Load the data from stg to datamart
INSERT INTO [dm].[DimReinsurance]([reinsurerName],[sapiensReinsurerID],[brokerName],[sapiensBrokerID],[sapiensPoolID],
[sapiensBatchID],[audit_Insert_Dt],[audit_Update_Dt],[ins_Proc_ID],[upd_Proc_ID],[is_Deleted],[is_Active])


  Select distinct [reinsurerName],
[sapiensReinsurerID],
[brokerName],
[sapiensBrokerID],
[sapiensPoolID],
