CREATE PROCEDURE [dm].[usp_DimAdjuster]

AS
/*
Procedure Name:  [dm].[usp_DimAdjuster]
Purpose: To load Adjuster data from staging 
Called by: DF
Calls: none
...
DECLARE @Ins_proc_id INT= 2

--- Insert the NA value SK
SET IDENTITY_INSERT [dm].[DimAdjuster] ON 

INSERT INTO [dm].[DimAdjuster] ([adjuster_SK],[adjusterName],[adjusterTRGUname],[managerName],[groupManagerName],
[department],[audit_Insert_Dt],[audit_Update_Dt],[ins_Proc_ID],[upd_Proc_ID],[is_Deleted],[is_Active])

VALUES (0, 'NA','NA','NA','NA','NA',@InsertDate,NULL, @Ins_proc_id,NULL,0,1)

SET IDENTITY_INSERT [dm].[DimAdjuster] OFF 
...
INSERT INTO [dm].[DimAdjuster] 
([adjusterName],[adjusterTRGUname],[managerName],[groupManagerName],
[department],[audit_Insert_Dt],[audit_Update_Dt],[ins_Proc_ID],[upd_Proc_ID],[is_Deleted],[is_Active])
