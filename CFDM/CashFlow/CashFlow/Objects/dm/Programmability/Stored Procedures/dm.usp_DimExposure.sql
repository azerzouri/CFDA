CREATE PROCEDURE [dm].[usp_DimExposure] AS
/*
...
DECLARE @Ins_proc_id INT = 5 --- Insert the NA value SK
SET
    IDENTITY_INSERT [dm].[DimExposure] ON
INSERT INTO
    [dm].[DimExposure] (
        [exposure_SK],
        [claimExposureNo],
...
SET
    IDENTITY_INSERT [dm].[DimExposure] OFF -- Load the data from stg to datamart
INSERT INTO
    [dm].[DimExposure] (
        [claimExposureNo],
        [insuredName],
