CREATE PROCEDURE [dm].[usp_DimWorkMatter]
...
DECLARE @Ins_proc_id INT= 1

--- Insert the NA value SK
SET IDENTITY_INSERT [dm].[DimWorkMatter] ON 

INSERT INTO [dm].[DimWorkMatter]([workMatter_SK],[workmatternumber],[workmatterDescription],[workmatterTypeDescription],
[workmatterStatus],[specialtrackinggroup],[account],[audit_Insert_Dt],[audit_Update_Dt],
[ins_Proc_ID],[upd_Proc_ID],[is_Deleted],[is_Active])

VALUES (0, 'NA','NA','NA','NA','NA','NA',@InsertDate,NULL, @Ins_proc_id,NULL,0,1)

SET IDENTITY_INSERT [dm].[DimWorkMatter] OFF 

-- Load the data from stg to datamart
INSERT INTO [dm].[DimWorkMatter]([workmatternumber],[workmatterDescription],[workmatterTypeDescription],
[workmatterStatus],[specialtrackinggroup],[account],[audit_Insert_Dt],[audit_Update_Dt],
[ins_Proc_ID],[upd_Proc_ID],[is_Deleted],[is_Active])
