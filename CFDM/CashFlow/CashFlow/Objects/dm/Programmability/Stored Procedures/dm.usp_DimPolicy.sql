CREATE PROCEDURE [dm].[usp_DimPolicy]

AS
/*
Procedure Name:  [dm].[usp_DimPolicy]
Purpose: To load Policy data from staging 
Called by: DF
Calls: none
...
DECLARE @Ins_proc_id INT= 6

--- Insert the NA value SK
SET IDENTITY_INSERT [dm].[DimPolicy] ON 

INSERT INTO [dm].[DimPolicy] ([policy_SK],[policyNumber],[portfolioCode],[NAICCode],[businessTypeCode],
...
SET IDENTITY_INSERT [dm].[DimPolicy] OFF 

-- Load the data from stg to datamart

INSERT INTO [dm].[DimPolicy] ([policyNumber],[portfolioCode],[NAICCode],[businessTypeCode],[audit_Insert_Dt]
