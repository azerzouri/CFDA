...
ALTER TABLE dbo.FactActuals ADD CONSTRAINT RefDimPolicy60 
    FOREIGN KEY (policy_SK)
    REFERENCES dm.DimPolicy(policy_SK)
go

ALTER TABLE dbo.FactActuals ADD CONSTRAINT RefDimPolicyCoverage61 
    FOREIGN KEY (policyCoverage_SK)
    REFERENCES dm.DimPolicyCoverage(policyCoverage_SK)
go

ALTER TABLE dbo.FactActuals ADD CONSTRAINT RefDimDate62 
    FOREIGN KEY (valuationDate_SK)
    REFERENCES dm.DimDate(Date_SK)
go

ALTER TABLE dbo.FactActuals ADD CONSTRAINT RefDimWorkmatter63 
    FOREIGN KEY (workMatter_SK)
    REFERENCES dm.DimWorkmatter(workMatter_SK)
go

ALTER TABLE dbo.FactActuals ADD CONSTRAINT RefDimReinsurance64 
    FOREIGN KEY (reinsurane_SK)
    REFERENCES dm.DimReinsurance(reinsurane_SK)
go

ALTER TABLE dbo.FactActuals ADD CONSTRAINT RefDimAdjuster65 
    FOREIGN KEY (adjuster_SK)
    REFERENCES dm.DimAdjuster(adjuster_SK)
go

ALTER TABLE dbo.FactActuals ADD CONSTRAINT RefDimExposure66 
    FOREIGN KEY (Exposure_SK)
    REFERENCES dm.DimExposure(Exposure_SK)
go

ALTER TABLE dbo.FactActuals ADD CONSTRAINT RefDimDate67 
    FOREIGN KEY (exposureOpenDate_SK)
    REFERENCES dm.DimDate(Date_SK)
go

ALTER TABLE dbo.FactActuals ADD CONSTRAINT RefDimDate68 
    FOREIGN KEY (exposureClosedDate_SK)
    REFERENCES dm.DimDate(Date_SK)
go

ALTER TABLE dbo.FactActuals ADD CONSTRAINT RefDimDate69 
    FOREIGN KEY (exposureReopenDate_SK)
    REFERENCES dm.DimDate(Date_SK)
go

ALTER TABLE dbo.FactActuals ADD CONSTRAINT RefDimDate70 
    FOREIGN KEY (policyEffectiveDate_SK)
    REFERENCES dm.DimDate(Date_SK)
go

ALTER TABLE dbo.FactActuals ADD CONSTRAINT RefDimDate71 
    FOREIGN KEY (policyExpirationDate_SK)
    REFERENCES dm.DimDate(Date_SK)
go

ALTER TABLE dbo.FactActuals ADD CONSTRAINT RefDimClaim72 
    FOREIGN KEY (claim_SK)
    REFERENCES dbo.DimClaim(claim_SK)
go

ALTER TABLE dbo.FactActuals ADD CONSTRAINT RefDimDate73 
    FOREIGN KEY (workmatterOpenDate_SK)
    REFERENCES dm.DimDate(Date_SK)
go

ALTER TABLE dbo.FactActuals ADD CONSTRAINT RefDimDate74 
    FOREIGN KEY (workmatterClosedDate_SK)
    REFERENCES dm.DimDate(Date_SK)
go

ALTER TABLE dbo.FactActuals ADD CONSTRAINT RefDimDate75 
...
ALTER TABLE dm.DimDate ADD CONSTRAINT RefFactCashFlow54 
    FOREIGN KEY (factCashFlow_SK)
    REFERENCES dm.FactCashFlow(factCashFlow_SK)
go
